...
FactoryGirl.define<User>('User', User, {
  password_hash:
    '$argon2id$v=19$m=65536,t=3,p=4$u+Gcc8tDqnefJIF/1YhzLQ$snrrA74SUZEFfptPa5lWC5POJ37rjd3ezWzl0dNOZfY', // password is password
