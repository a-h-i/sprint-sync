...
import {LoginResponseSchema, LoginResponseSchemaType} from "@/lib/schemas/loginResponse.schema";
...
export function setToken(cookieStore: ReadonlyRequestCookies, data: LoginResponseSchemaType) {
...
export function setCurrentUser(cookieStore: ReadonlyRequestCookies, user: UserSchemaType) {
