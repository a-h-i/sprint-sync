...
import {changePassword, createUser, listUsers, updateProfile} from "@sprint-sync/control";
...
export class ProfileService {
    ...
    async updatePassword(id: number, body: ChangePasswordDto) {
        const success = await changePassword(this.source.manager, id, body.newPassword, body.oldPassword);
        if (!success) {
